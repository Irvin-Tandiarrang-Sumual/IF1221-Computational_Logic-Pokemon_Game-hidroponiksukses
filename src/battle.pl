...
init_poke(Index) :-
    party(Index, Pokemon),
    curr_health(Index, Pokemon, CurrHP),
    player(_, _, _, _, _, _, Level),
    ...
    assertz(statusKita(CurrHP, MaxHP, ATK, DEF, Pokemon, 1, _, Index)).
...
turn :-
    ...
    (
        HP1 =< 0 ->
            ...
            retractall(curr_health(1, Name1, _)),
            assertz(curr_health(1, Name1, 0)),
